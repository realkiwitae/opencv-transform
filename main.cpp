...
Mat rotate_and_translate(Mat array, double angle_in_degrees , int cx , int cy);
Mat rotate_and_translate2(Mat array, double angle_in_degrees , int cx , int cy);

int main() {
    Mat image = imread("./media/lena.png");
    Mat rotated_image = rotate_and_translate2(image, 45,image.cols/2,image.rows/2);
